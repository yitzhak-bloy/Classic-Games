...
const updateTicTacToeStatistics = async (req, res, next) => {
  ...
  ticTacToeStatistic.averageRating = outcome === "victory" ? ticTacToeStatistic.averageRating + 1 : outcome === "loss" ? ticTacToeStatistic.averageRating - 1 : ticTacToeStatistic.averageRating;
